...
<head>
    ...
    <link rel="stylesheet"
          href="{{asset('AdminAsset/assets/vendors/mdi/css/materialdesignicons.min.css')}}">
...
@if(auth()->user())
    @if(auth()->user()->role_id == 1)
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
                    ...
                    <a class=" sidebar-brand brand-logo" style="color: white; text-decoration: none;" href="{{route('AdminHome')}}">
                     <h3 style="color: #2f5687 !important">Refectio</h3>
                    </a>
                ...
                <i class="mdi mdi-account-multiple-plus"></i>
                        ...
                        <div class="collapse" id="ui-basic" style="">
                            <ul class="nav flex-column sub-menu">
                                <?php $NewDesignerCount = App\Models\User::where('role_id', 2)->where('active',1)->count()?>

                                <li class="nav-item"> <div style="display: flex; align-items: center;     justify-content: space-between;"> <a href="{{route('newDesigner')}}" class="nav-link" >Дизайнеры </a>
                                        <div style="
                                        width: 25px;   border-radius: 50px;
                                            ...
                                            <p style="padding: 3px;"> {{$NewDesignerCount}} </p>
                                        </div>
                                    </div>
                                </li>
                                    <?php $newProizvoditelCount = App\Models\User::where('role_id', 3)->where('active',1)->count() ?>
                                <li class="nav-item"> <div style="display: flex; align-items: center;     justify-content: space-between;"><a href="{{route('newProizvoditel')}}" class="nav-link" >Производители  </a><div style="
                                        width: 25px;   border-radius: 50px;
                                                background-color: #2f5687;
                                                height: 25px;
                                                display: flex;
                                                justify-content: center;
                                                 align-items: flex-start;"> <p style="padding: 3px">{{$newProizvoditelCount}}</p> </div> </div> </li>
                            </ul>
                        </div>
                    </li>
                    <li class="nav-item menu-items">
                        <a class="nav-link collapsed" data-toggle="collapse" href="#auth2" aria-expanded="false" aria-controls="auth">
              <span class="menu-icon">
                <i class="mdi mdi-account-star"></i>
                        ...
                        <div class="collapse" id="auth2" style="">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="{{route('AllDesigner')}}"> Дизайнеры </a></li>
                                <li class="nav-item"> <a class="nav-link" href="{{route('AllProizvoditel')}}"> Производители </a></li>

                            </ul>
                        </div>
                    </li>
                    <li class="nav-item menu-items">
                        <a class="nav-link" href="{{route('AllBrone')}}">
              <span class="menu-icon">
                <i class="mdi mdi-book-variant"></i>
              </span>
                            <span class="menu-title">Брони</span>
                        </a>
                    </li>
                </ul>
            </nav>
                        ...
                        <ul class="navbar-nav navbar-nav-right">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list"
                                    ...
                                    <div class="dropdown-divider"></div>
                                    <a href="{{route('AdminLogout')}}" class="dropdown-item preview-item">
                                        <div class="preview-thumbnail">
                                            <div class="preview-icon bg-dark rounded-circle">
        ...
        <script src="{{asset('AdminAsset/assets/js/my_main.js')}}"></script>
